  ...
  return (
    <section className="pt-[120px] pb-[138px] lg:pt-0 lg:pb-[120px]">
      <div className="relative container bg-white pt-[40px] pb-[89px] lg:pt-[90px] lg:pb-[195px] mx-auto px-[16px] lg:px-[40px]">
        <div className="absolute z-10 bottom-[26px] lg:bottom-[119px] left-1/2 -translate-x-1/2 lg:left-[auto] lg:translate-x-0 md:right-[-88px] w-[540px] h-[314px] xl:w-[900px] xl:h-[676px]">
          <Image
        ...
        <div className="relative rounded-[8px] overflow-hidden w-full text-left bg-[#F4E1C1] px-[30px] pt-[32px] lg:pt-[64px] pb-[187px] lg:pb-[64px]">
