        ...
        <div className="relative z-20 py-6 md:py-[89px] md:bg-white md:rounded-[8px] overflow-hidden">
          ...
          <div className="md:pl-[87px]">
            <AnimatedWrapper
              ...
              className="md:w-[363px] xl:w-[383px] laptop:w-[463px] mb-2 md:mb-4 text-center md:text-left uppercase font-arial text-[18px] xl:text-[32px] leading-[127%] laptop:leading-[140%]"
            >
              {title}
            </AnimatedWrapper>
            <AnimatedWrapper
              ...
              className="md:w-[363px] xl:w-[383px] laptop:w-[515px] mb-[235px] md:mb-8 text-[12px] xl:text-[18px] leading-[130%] text-center md:text-left"
            >
              {description}
            </AnimatedWrapper>
            <AnimatedWrapper
            ...
            >
              <Link href="/partnership" className="block w-full">
                <Button className="w-full xl:h-[67px]" text={becomePartner} />
              </Link>
