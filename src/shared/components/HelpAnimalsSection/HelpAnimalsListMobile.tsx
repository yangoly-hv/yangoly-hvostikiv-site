...
const HelpAnimalsListMobile = ({ list }: { list: IHelpAnimalsListItem[] }) => {
  return (
    <motion.div
      ...
      className="grid lg:hidden grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5"
    >
      {list.map((item, index) => (
        <motion.div
          variants={listItemVariants}
          className="flex flex-col justify-between h-full rounded-[8px] border-[3px] border-orange py-[21px] px-[7px]"
          key={index}
        >
          <div>
...
export default HelpAnimalsListMobile;
