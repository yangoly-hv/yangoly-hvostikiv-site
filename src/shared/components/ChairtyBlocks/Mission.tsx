...
const Mission = ({ missionTitle, missionParagraph }: IMissionProps) => {
  return (
    <section className="pt-[120px] xl:pt-[56px]">
      <div className="relative container mx-auto px-4 xl:px-[40px] max-w-[1432px] flex flex-col-reverse items-center gap-[20px] md:grid md:grid-cols-[minmax(0,698px)_minmax(0,734px)] md:items-stretch md:gap-0 md:max-h-[317px]">
