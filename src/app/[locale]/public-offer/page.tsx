...
const UA_LINES = [
    ...
    "Акцепт – повне та безумовне прийняття Оферти шляхом вчинення дій, спрямованих на здійснення грошового переказу як за допомогою платіжних форм та засобів, які розміщені на сайті https://angelsua.org/uk, так і шляхом перерахування грошових коштів на поточний рахунок Фонду.",
    ...
    "Публічний збір коштів триває до моменту припинення діяльності Фонду (в т.ч. шляхом ліквідації), якщо інший строк не буде визначений рішенням Фонду, про що Благодійник буде повідомлений шляхом розміщення відповідної інформації на сайті Фонду https://angelsua.org/uk.",
...
const EN_LINES = [
    ...
    "DEFINITIONS",
    "Public offer (and/or Offer) means a valid offer of the Foundation published on the website https://angelsua.org/en to make a charitable donation, addressed to an indefinite number of individuals.",
    "Acceptance means full and unconditional acceptance of the Offer by performing actions aimed at making a monetary transfer using the payment forms and methods available on the website https://angelsua.org/en, as well as by transferring funds to the Foundation’s current bank account.",
    ...
    "annually, in electronic form, report on the use of charitable donations by publishing relevant information on the website: https://angelsua.org/en;",
    ...
    "FUNDRAISING PERIOD",
    "Public fundraising continues until the Foundation’s activity is terminated (including by liquidation), unless another period is determined by the Foundation’s decision, of which the Donor will be informed by publishing relevant information on the Foundation’s website https://angelsua.org/en.",
    ...
    "The Foundation uses charitable donations in accordance with its statutory activities and the Foundation’s programs. Charitable donations received by the Foundation may be returned to the Donor only in cases provided for by the legislation of Ukraine and this Agreement.",
    ...
    "Other information is disclosed by the Foundation in the manner and scope provided for by the legislation of Ukraine.",
